...
public class IdentifyDataProxy extends HttpServlet {
	String prodServerBase = "http://cida.usgs.gov";
	String localServerBase = "http://localhost:8280";
	String serverBase = localServerBase;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestType serviceRequest = RequestType.valueOf(requestType);
		url = serviceRequest.makeRESTUrl(req.getParameter("agency_cd"), req.getParameter("siteNo"));

		System.out.println("gw_data_portal fetching data from get url: " + url);
